## Description: <br>
Use for any NVIDIA Nemotron Speech (formerly Riva) NIM task — deploy, run, or test ASR (speech-to-text), TTS (text-to-speech), or NMT (translation) speech NIMs, either cloud-hosted via build.nvidia.com or self-hosted on your own GPU. <br>
